...
<div class="mask" onclick="javascript:closeLightbox();"></div>
  ...
  <div id="layer-transparent" class="layer-searc" >
    <header class="navbar" id="header-top">
      <div class="tarja vPadding" id="tarja-header">
      ...
      <div class="container vPadding">
        ...
        <span class="icon-pesquisa pesquisa" title="Pesquisar"></span>  
        <div class="busca-top">
          <form role="search" method="get" id="form_pesquisa" class="form_pesquisa_mobile" action="<?php echo esc_url( home_url( '/' ) ); ?>">
            ...
            <input type="search" class= mobile_search" name="s" placeholder="Pesquise no Site" />
            <button type="submit" class="submitSerch"></button>
          </form>
        </div>

        <div class="logoSite module absolute left middle">
            ...
            <ul id="menu-menu" class="nav navbar-nav">
              ...
              <?php if( is_blog_content() ) { ?>
                ...
                <li class="menu-item itemNav <?php echo $class; ?>">
                  <a class="linkNav" href="<?php echo $link; ?>" title="<?php echo $title; ?>">
                    <?php echo $title; ?>
                  </a>
                </li>                       
                <?php  endforeach; ?>
                ...
                <li class="menu-item itemNav">
                  <a href="<?php echo get_home_url(); ?>/veiculos" class="linkNav">VEÍCULOS</a>
                </li>
                <li class="menu-item itemNav">
                  <a href="<?php echo get_home_url(); ?>/planos" class="linkNav">PLANOS</a>
                </li>
                <li class="menu-item itemNav">
                  <a href="<?php echo get_home_url(); ?>/consorcio-chevrolet" class="linkNav">CONSÓRCIO</a>
                </li>
                <li class="menu-item itemNav">
                  <a href="<?php echo get_home_url(); ?>/blog/" class="linkNav">BLOG</a>
                </li>
                <li class="menu-item itemNav">
                  <a href="<?php echo get_home_url(); ?>/depoimentos" class="linkNav">DEPOIMENTOS</a>
                </li>
                <li class="menu-item itemNav">
                  <a href="<?php echo get_home_url(); ?>/atendimento" class="linkNav">ATENDIMENTO</a>
                </li>
          ...
          <div id="bs-example-navbar-collapse-1 menu-top" class="menu collapse navbar-collapse">
            <ul id="menu-menu" class="nav navbar-nav">
              ...
              <?php if( is_home() && is_front_page() ): ?>
                ...
                <li class="menu-item itemNav">
                  <a href="#carros" class="linkNav scroll">VEÍCULOS</a>
                </li>
                <li class="menu-item itemNav">
                  <a href="#planos" class="linkNav scroll">PLANOS</a>
                </li>
                <li class="menu-item itemNav">
                  <a href="#consorcio" class="linkNav scroll">CONSÓRCIO</a>
                </li>
                <li class="menu-item itemNav">
                  <a href="#blog" class="linkNav scroll">BLOG</a>
                </li>
                <li class="menu-item itemNav">
                  <a href="#depoimentos" class="linkNav scroll">DEPOIMENTOS</a>
                </li>
                <li class="menu-item itemNav">
                  <a href="#atendimento" class="linkNav scroll">ATENDIMENTO</a>
                </li>
              <?php else: ?>
