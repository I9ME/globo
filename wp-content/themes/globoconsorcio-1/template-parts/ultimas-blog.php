  ...
  <div class="container vPadding"> 
    ...
    <ul class="ultimasblog__blocoplanos nRow grid items border colls colls-3 hPaddings topPadding_2 shadowHover">
     <?php 
      ...
      <li class="coll item intraMargin-right">
        <div >
          <h5><?php echo get_the_title(); ?></h5>
          <br/><hr class="gray"><br/>
          <p><?php echo get_the_excerpt(); ?></p>
           <?php trackButton('link', 'postBlog_'. get_the_ID(), 'Clicado', get_the_title(), get_post_permalink(), get_the_title(), 'postBlogView_'. get_the_ID(), 'btn btn__nossoblog ', 'Ler Mais', 'blog'); 
